...
// Dialog (modal) de shadcn/ui: se usa para crear/editar registros
// (clientes, productos, recetas...) SIN recargar la página.
...
/** Contenido centrado del modal con botón de cerrar incluido */
